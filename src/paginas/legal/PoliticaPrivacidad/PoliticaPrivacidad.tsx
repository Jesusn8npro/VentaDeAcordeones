      ...
      <div className="politica-content">
        <div className="seccion">
          ...
          <div className="seccion-contenido">
            <p>
              La presente Política de Privacidad establece los términos en que <strong>VentaDeAcordeones.com</strong> 
        ...
        <div className="seccion">
          ...
          <div className="seccion-contenido">
            <p>
              <strong>VentaDeAcordeones.com</strong> está altamente comprometido para cumplir con el compromiso 
