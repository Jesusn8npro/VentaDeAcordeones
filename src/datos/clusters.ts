...
export const BASES: Record<BaseCluster, { nombre: string; titulo: string; descripcion: string; h1: [string, string]; intro: string; wa: string }> = {
  accesorios: {
    ...
    intro: 'Parrillas, fuelles, correas, estuches y broches para Hohner Corona II, Corona III, Rey Vallenato y Compadre. Originales, económicos y personalizados con tu nombre, fabricados o instalados en nuestro taller de Valledupar.',
    wa: 'Hola, busco accesorios para mi acordeón',
  },
  instrumentos: {
    nombre: 'Instrumentos',
    titulo: 'Cajas Vallenatas, Baterías y Percusión | Distribuidor Miche en Colombia | VentaDeAcordeones.com',
    descripcion: 'Cajas vallenatas Miche, baterías MPRO y Ludwig, guacharacas y percusión para tu conjunto vallenato. Distribuidor autorizado. Precios de mayorista y envío a toda Colombia.',
    h1: ['El conjunto completo', 'caja, guacharaca y batería'],
    intro: 'Somos distribuidores autorizados de Miche, MPRO y Ludwig. Cajas vallenatas en madera y acrílico, baterías junior y profesionales, guacharacas y percusión menor con precio de mayorista para músicos y tiendas.',
...
export const CLUSTERS: Cluster[] = [
  {
    ...
    chips: ['Compatible Corona II y III', 'Rey Vallenato · Compadre', 'Corte láser en Valledupar'],
    beneficios: [
    ...
    faq: [
      ...
      { p: '¿Puedo instalarla yo mismo?', r: 'Sí, sólo necesitas un destornillador de estrella. Te enviamos el video paso a paso. Si prefieres, la instalamos sin costo en Valledupar.' },
  ...
  },
  {
    ...
    icono: 'acc-fuelle',
    palabras: ['fuelle'],
    chips: ['Hermético · sin fugas', '18 y 19 pliegues', 'Cambio en taller Valledupar'],
    beneficios: [
    ...
    faq: [
      ...
      { p: '¿Cuánto cuesta el cambio de fuelle en el taller?', r: 'La mano de obra está incluida si compras el fuelle con nosotros y traes el acordeón a Valledupar. Para envíos, te guiamos a tu técnico local.' },
    ],
  ...
  // ── INSTRUMENTOS (distribuidor Miche / MPRO / Ludwig) ──
  {
    ...
    h1: ['Cajas vallenatas', 'en madera y acrílico, listas para la parranda'],
    titulo: 'Cajas Vallenatas Miche en Madera y Acrílico | Distribuidor Autorizado | VentaDeAcordeones.com',
    descripcion:
      'Cajas vallenatas Miche en madera de alta calidad y acrílico de colores, aros y soportes cromados, parche acrílico. Precio de distribuidor y envío a toda Colombia.',
    eyebrow: 'Instrumentos · Cajas vallenatas',
    intro:
      'La caja marca el paso del paseo, el merengue, la puya y el son. Tenemos cajas Miche en madera natural o pintada y en acrílico transparente de colores, con aros y soportes cromados y parche acrílico afinable.',
    imagen: '/images/clusters/caja-vallenata.webp',
    icono: 'cat-bateria',
    palabras: ['caja vallenata'],
    chips: ['Madera o acrílico', 'Aros cromados', 'Parche acrílico afinable'],
    beneficios: [
      ...
      { titulo: 'Precio de distribuidor', texto: 'Somos distribuidores autorizados Miche: precio directo y garantía de fábrica.' },
    ],
    guia: {
      titulo: '¿Madera o acrílico?',
      parrafos: [
        'La caja de madera tiene el sonido tradicional, más cálido y seco, y es la preferida para grabación y para conjuntos clásicos. La caja acrílica proyecta más brillo y volumen, se ve espectacular en escenario y resiste mejor la humedad de la costa.',
        'Ambas usan parche acrílico afinable con llave, así que puedes ajustar el tono a tu gusto y al del acordeón. Si compras caja + guacharaca juntas te armamos el combo con descuento.',
      ],
      lista: ['Elige madera (tradicional) o acrílico (tarima)', 'Escoge el color', 'Añade guacharaca y baquetas si las necesitas', 'Pide el combo por WhatsApp y te cotizamos con envío'],
    },
    faq: [
      ...
      { p: '¿Tienen guacharacas?', r: 'Sí, guacharacas en madera con trinche. Pídelas en combo con la caja.' },
  ...
  },
  {
    ...
    faq: [
      ...
      { p: '¿Cómo llega el envío?', r: 'En cajas selladas de fábrica con instrucciones de armado; en Valledupar y Bogotá podemos entregarla armada.' },
