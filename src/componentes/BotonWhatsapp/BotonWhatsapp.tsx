...
const BotonWhatsapp = () => {
  ...
  const numeroWhatsapp = '573144865310';
  
  // Mensaje predeterminado súper vendedor
  const mensajePredeterminado = encodeURIComponent(
    '¡Hola! 👋 Vi sus productos en VentaDeAcordeones.com y estoy muy interesado/a. ¿Podrían ayudarme con información sobre precios y disponibilidad? 🛍️✨'
  );
