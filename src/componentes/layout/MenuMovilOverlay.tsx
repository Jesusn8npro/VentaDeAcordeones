        ...
        <div className="overlay-header">
          <div className="overlay-brand">
            <div className="overlay-logo">
              <span className="overlay-logo-text">VentaDeAcordeones</span>
              <span className="overlay-logo-accent">.com</span>
            </div>
            <span className="overlay-tagline">Acordeones para toda Colombia</span>
          </div>
